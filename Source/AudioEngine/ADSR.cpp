...
SynthLab::ADSR::ADSR(void) {
    reset();
    setAttackRate(1 * 48000);
    setDecayRate(5 * 48000);
    setReleaseRate(0.2 * 48000);
    setSustainLevel(1.0);
    setTargetRatioA(0.3);
